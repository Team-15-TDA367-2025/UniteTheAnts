...
public class ResourceNode extends Structure implements Updatable, TimeObserver {
    ...
    public ResourceNode(TimeCycle timeCycle , GridPoint2 position, String textureName, int radius,
